              ...
              @if (Auth::user()->role_type == "GA")
                  <li class="treeview" id="menu_master">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_internal"><a href="{{url('internals')}}"><i class="fa fa-tag"></i> internal</a></li>
                      <li id="submenu_externs"><a href="{{url('externals')}}"><i class="fa fa-tag"></i> Externals</a></li>
                    </ul>
                  </li>
                @endif
                <li id="menu_order"><a href="{{url('orders/')}}"><i class="fa fa-first-order"></i> <span>Order</span></a></li>
