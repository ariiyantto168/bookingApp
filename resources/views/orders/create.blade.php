            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select name="externals[]" class="form-control select2" multiple="multiple">
                      @foreach ($externals as $external)
                        <option value="{{$external->idexternals}}">{{$external->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                  ...
                  <div class="col-sm-5">
                    <select name="internals[]" class="form-control select2" multiple="multiple">
                      @foreach ($internals as $internal)
                        <option value="{{$internal->idinternals}}">{{$internal->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
